				...
				<view class="flex">
					...
					<view class="flex">
						<view class="radio-group">
							<view class="radio mr-20rpx" :class="{ 'checked': !form.taitou }" @tap="form.taitou = 0">个人
							</view>
		...
		<view class="invoice-box-2">
			<list-cell :hover="false" line-left line-right>
				<view class="flex w-full">
					...
					<view class="flex-auto flex">
						<input class="flex-auto mr-20rpx" type="text" v-model="form.username" placeholder="请输入姓名"
							placeholder-class="font-size-24rpx text-color-assist">
			...
			<list-cell :hover="false" line-left line-right>
				<view class="flex w-full">
					...
					<view class="flex-auto flex">
						<input class="flex-auto mr-20rpx" type="text" v-model="form.email" placeholder="请输入邮箱地址"
							placeholder-class="font-size-24rpx text-color-assist">
						<view class="text-color-danger">必填</view>
					</view>
				</view>
			...
			<list-cell :hover="false" line-left line-right>
				<view class="flex w-full">
					...
					<view class="flex-auto flex">
						<input class="flex-auto mr-20rpx" type="text" v-model="form.telphone" placeholder="请输入手机号码"
							placeholder-class="font-size-24rpx text-color-assist">
						<view class="text-color-danger">必填</view>
					</view>
				</view>
