		...
		<view class="content">
			<list-cell last class="mb-20rpx" :hover="false">
				<view class="w-full flex justify-between items-center">
					<view class="font-size-32rpx text-color-base flex-auto">{{ storename }}</view>
					<view class="font-size-28rpx text-color-assist mr-10rpx">{{ date }}</view>
					<view class="font-size-28rpx text-color-assist">{{ typeCate == 1 ? '堂食' : '外卖' }}</view>
				</view>
			</list-cell>
			<view class="review-form">
				<view class="review-rate-form mb-20rpx">
				...
				<view class="review-textarea-form">
					...
					<view class="text-right font-size-24rpx text-color-assist">{{ form.opinion.length }}/500</view>
				</view>
			</view>
		</view>
		<view class="btn-box">
